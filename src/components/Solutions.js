...
export default function Solutions() {
    ...
    <Solution
      item={{
        ...
        function Solution(){            
           ...
           return <div>{multiplesOf3And5()}</div>
           }
                    `,
        key: "1"
      }}
    ...
    <Solution
      item={{
        ...
        solution: `function Solution(){            
            ...
            function sumFibUnderFourMillion(){
                var i=1; var currentFib=fib(1); var sum=0;
                  while (currentFib<4000000){
                      currentFib=fib(i++);
                      if (currentFib%2===0) {sum=sum+currentFib}
                  } return sum;
              }
               
           return <div>{sumFibUnderFourMillion()}</div>
           }
                    `,
        key: "2"
      }}
  ...
  const handleSubmit = e => {
    e.preventDefault();
    setSolutions([...solutions, <Solution item={newSolution} />]);
